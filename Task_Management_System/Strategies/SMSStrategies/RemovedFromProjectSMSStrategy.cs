...
{
    public class RemovedFromProjectSMSStrategy(SMSSettings smsSettings) : INotificationStrategy
    {
                ...
                var data = $@"{{
                    ""messages"": [
                         {{
                              ...
                              ""text"": ""{userName}, you have been removed from project {body["ProjectName"]}""
                        }}
                      ]
                    }}";
